...
NCOUNTERS_BUSY_DDL2_BLOCKS=152   # from 23.11.2015
  ...
  def getSet(self,brd):
    ...
    if brd=='fo':
      for ix in (1,2,3,4,5,6):
        ...
        if brd in self.boards:
          rc.append[bn]
    elif brd in self.boards:
      rc.append[bn]
    if rc==[]: rc=None
    return rc

class SHMCounter(object):
  pxwidth=500
  pxheight=46
  xresolution=2
...
""")
    ...
    for foix in [1,2,3,4,5,6]:
      ...
      if self.printnames==None:
        if fona not in self.ctpboards.boards: continue  #FO not in crate
...
""")
  ...
  def findAddr(self, cntlabel, col5=None):
    ...
    #------------------------------------------------------ L0
    if cntlabel.find("l0byclst")==0:
      board="l0"; c= cntlabel[8]; CGT='T';
      if c=="T": n= 0
      else: n= int(c)
    elif cntlabel.find("l0pf")==0:
      board="l0"; 
    ...
    elif cntlabel.find("allrare")==0:
      board="l0"; n= 14; CGT='T';
    elif cntlabel.find("l0time")==0:
      board="l0"; n= 15; CGT='T';
    elif cntlabel.find("l0rate28")==0:
      board="l0"; n= 16; CGT='T';
    elif cntlabel.find("l0classB")==0:
      board="l0"; n= (19-1)+ int(cntlabel[8:])
    elif cntlabel.find("l0inp")==0:   #l0inp1: 116
      board="l0"; n= (119-1)+ int(cntlabel[5:])
    elif cntlabel.find("l0ifun")==0:  # l0ifun1: 140
      board="l0"; 
      c1234= cntlabel[6]
    ...
    elif cntlabel.find("lm_out")==0:
      board="l0"; n= 186
    elif cntlabel.find("l0strobe0")==0:   # 148
      board="l0"; n= 171
    elif cntlabel.find("l0classA")==0:    # run2: l0classA1: 152
      board="l0"; n= (187-1)+ int(cntlabel[8:])   # run1: 99
    elif cntlabel.find("s_soft")==0:
      board="l0"; n= 287 #102+150
    elif cntlabel.find("prepulse")==0:
      board="l0"; n= 288 #102+151
    elif cntlabel.find("l0clst")==0:
      board="l0"; c= cntlabel[6];
      if c=="T": n= 289 # 102+152
      else: n= (290-1) + int(c)  #102+152+int(c)
    elif cntlabel.find("lmclassB")==0:
      board="l0"; n= int(cntlabel[8:]) - 1 + L0200SH
    elif cntlabel.find("lmclassA")==0:
      board="l0"; n= 100 + int(cntlabel[8:]) - 1 + L0200SH
    #------------------------------------------------------ L1
    elif cntlabel.find("l1pf")==0:
      board="l1"; c= cntlabel[4]; CGT='T';
      if c=="T": n= 0 +L1SH
      else: n= int(c) +L1SH
    elif cntlabel.find("l1time")==0:
      board="l1"; n= 5+L1SH; CGT='T';
    elif cntlabel.find("l1inp")==0:
      board="l1"; n= 5+L1SH+ int(cntlabel[5:])
    elif cntlabel.find("l1int")==0:
    ...
    elif cntlabel.find("l0strobeIN")==0:
      board="l1"; n= 35+L1SH
    elif cntlabel.find("l1strobeOUT")==0:
      board="l1"; n= 36+L1SH
    elif cntlabel.find("esrflag")==0:
      board="l1"; n= 37+L1SH
    elif cntlabel.find("l1classB")==0:
      board="l1"; n= 39+L1SH+ int(cntlabel[8:])
    elif cntlabel.find("l1classA")==0:
      board="l1"; n= 139+L1SH+ int(cntlabel[8:])   #run1:89
    elif cntlabel.find("l1clst")==0:
      board="l1"; c= cntlabel[6];
      if   c=="T": n= 241+L1SH   #141
      elif c=="0": n= 240+L1SH   #140
      else: n= 241+L1SH+int(c)   #141/6 or run2:241/8
    #------------------------------------------------------ L2
    elif cntlabel.find("l2pf")==0:
      board="l2"; c= cntlabel[4]; CGT='T';
      if c=="T": n= 0 +L2SH
      else: n= int(c) +L2SH
    elif cntlabel.find("l2time")==0:
      board="l2"; n= 5+L2SH; CGT='T';
    elif cntlabel.find("l2inp")==0:
      board="l2"; n= 5+L2SH+ int(cntlabel[5:])
    elif cntlabel.find("l2int")==0:
    ...
    elif cntlabel.find("l1strobeIN")==0:
      board="l2"; n= 23+L2SH
    elif cntlabel.find("l2strobeOUT")==0:
      board="l2"; n= 24+L2SH
    elif cntlabel.find("l2classB")==0:
      board="l2"; n= 25+L2SH+ int(cntlabel[8:])
    elif cntlabel.find("l2classA")==0:
      board="l2"; n= 125+L2SH+ int(cntlabel[8:])   # run1:75
    elif cntlabel.find("l2clst")==0:
    ...
    #------------------------------------------------------ FO
      ...
      if col5: det5c= self.findLTUfo(foix, int(c)) 
    #------------------------------------------------------ INT
    elif cntlabel.find("intCTPbusy")==0:
      board="int"; n= 0+ INTSH; CGT='T';
    elif cntlabel.find("fiLF")==0:
      board="int"; n= 1+ INTSH; CGT='T';
    elif cntlabel.find("inttime")==0:
      board="int"; n= 2+ INTSH; CGT='T';
    elif cntlabel.find("int1")==0:
      board="int"; n= 3+ INTSH
    elif cntlabel.find("int2")==0:
      board="int"; n= 4+ INTSH
    elif cntlabel.find("intL1S")==0:
      board="int"; n= 5+ INTSH
    elif cntlabel.find("intL2S")==0:
      board="int"; n= 6+ INTSH
    elif cntlabel.find("L2rseq")==0:
      board="int"; n= 7+ INTSH
    elif cntlabel.find("L2aseq")==0:
      board="int"; n= 8+ INTSH
    elif cntlabel.find("rd_block")==0:
      board="int"; n= 9+ INTSH
    elif cntlabel.find("rc_block")==0:
      board="int"; n= 10+ INTSH
    elif cntlabel.find("orbit_err")==0:
      board="int"; n= 11+ INTSH
    elif cntlabel.find("ctpbusy_pulse")==0:
      board="int"; n= 12+ INTSH
    elif cntlabel.find("lf_pulse")==0:
      board="int"; n= 13+ INTSH
    elif cntlabel.find("L2a_tc")==0:
      board="int"; n= 14+ INTSH
    elif cntlabel.find("tc_input1")==0:
      board="int"; n= 15+ INTSH
    elif cntlabel.find("tc_input2")==0:
      board="int"; n= 16+ INTSH
    elif cntlabel.find("incomplete")==0:
      board="int"; n= 17+ INTSH
    elif cntlabel.find("orc_error")==0:
