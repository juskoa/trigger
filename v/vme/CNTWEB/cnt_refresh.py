...
"""
  ...
  html= html + """<BR>Warning: I (Renato Borges) have changed this page in 9/7/2009 to self-refresh every minute. If this causes problems, it can be reverted by running the following commands on a terminal:<BR>
  sshs<BR>
