...
{
 l2a.SetName("FOL2a");
 l2a.SetIXs(CSTART_L2+NCOUNTERS_FO*(fo-1)+44+(focon-1),CSTART_FO+ NCOUNTERS_FO*(fo-1)); 
}
...
//////////////////////////////////////////////////////////////////////
TriggerClass::TriggerClass(string &name,int index, TriggerCluster *cluster)
:
fname(name),
fIndex(index),
fCluster(cluster),
...
{
 cout << fname << " " << fIndex << " " << fCluster->GetName();
 cout << " " << fCluster << " " << fGroup << " " << fTime  << endl;
}
//--------------------------------------------------------------------------
TriggerClasswCount::TriggerClasswCount(string &name,int index, TriggerCluster *cluster)
