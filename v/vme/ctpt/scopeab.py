...
class ABsig:
  ...
  signals={
    "foA":[ ["bp_bc","0"],
     ...
     ["DelayedL1Cluster","24"], ["VMEstrobe","25"]],
    "foB":[
    ...
    "l1A":[
     ...
     ["L0strBeforeDelay","9"], ["L0datainBeforeDelay","10"], 
     ["INT1","11"], ["INT2","12"],
    ...
    "l2A":[
     ["pll_bc","0"], ["orbit","1"], ["TestClassBV","2"], ["GND","3"],
     ["GND","4"], ["GND","5"], ["GND","6"], ["GND","7"], ["GND","8"],
     ["L1strBeforeDelay","9"], ["L1datainBeforeDelay","10"], 
     ["INT1","11"], ["INT2","12"],
     ["GND","13"], ["GND","14"], ["GND","15"],
     ["PF1","16"], ["PF2","17"], ["PF3","18"], ["PF4","19"], ["PFT","20"],
     ["ADCinput_overlap","21"], ["GND","22"], ["strobe","23"], 
    ...
    "l2B":[ ["bcAfterPLL","0"], ["orbit","1"],
     ...
     ["l2clst6","8"], ["l1strobeAfterDelay","9"], ["l2strobeOut","10"],
