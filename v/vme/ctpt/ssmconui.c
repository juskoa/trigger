...
int FOLTUConnection(int ltu){	
 if(ltu == 16)return A2BCD(3,"fo1_outgen","ltu1_i1",0);
 else if(ltu == 18) return A2BCD(3,"fo1_outgen","ltu2_i1",0);
 else return 0xffff; 
 ...
 */ 
int L1FOconnection(){
 return A2BCD(3,"l1_outgen","fo3_inmonl1",0);	
}
/*FGROUP Connections
 * L1-> FO connection
 * L1 mode
...
int L1outFOs(){
 ...
 A2BCD(7,"none_none","l1_outmon","fo1_inmonl1","fo2_inmonl1","fo3_inmonl2","fo4_inmonl2",7);
 return 0;
}
/*FGROUP Monitor
 * ------------------------------------------------------------------
 ...
 */ 
int L0inBUout(){
 return A2BCD(4,"none_none","l0_inmon","busy_outmon",2);
}
/*FGROUP Generate
 * generate synchronous sw trigger and check BC in ssm
 * none mode
 */
int BCoffset(){
 return A2BCD(4,"none_none","l2_outmon","int_ddldat",6);
}
/*FGROUP Monitor
 * ------------------------------------------------------------------
